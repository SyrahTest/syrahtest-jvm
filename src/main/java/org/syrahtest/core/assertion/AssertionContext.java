...
package org.syrahtest.core.assertion;

/**
 * An assertion context holds all of the assertions that were executed inside of the context.
 * When the context is cleared all previous assertions will be removed.
 *
